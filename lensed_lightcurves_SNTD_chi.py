...
delta_t_list = [10, 15,20,25, 30]
delta_t_list = np.linspace(5,40, 10)
...
for cadence in cadence_list:
    for dt_val in delta_t_list:
        ...
        dt_1 = -dt_val/2  # dt gives time of peak relative to t0, hence the subtraction
        dt_2 = dt_val/2
        model.set(**{'dt_1':dt_1})
        model.set(**{'dt_2':dt_2})
        ...
        unresolved.set_delays([dt_1,dt_2])   #ie using correct guesses
        ...
        chisq = fitCurves.images['image_1'].chisq
        reduced_chisq = fitCurves.images['image_1'].reduced_chisq    # THIS IS HOW YOU OBTAIN IT. 
        #FOR SOME REASON, fitCurves.series_chisq doesn't work, even though series_chisq IS a property of the MISN class too
        print(chisq)
        print(reduced_chisq)
        # print('x')
        chisq_list.append(chisq)
        red_chisq_list.append(reduced_chisq)
